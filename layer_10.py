...
Original file is located at
    https://colab.research.google.com/drive/1ucy5o1eeBzk4-xv4GpyNMU1veKTcoEcX
"""
...
train_df = pd.read_csv("train_10.csv")
...
with open('layer_10_label_1.csv', mode='w', newline='') as file:
...
print("CSV file 'layer_10_label_1.csv' has been created.")
...
#cross validation
crossValidationFunction(tuned_model1, x_pca_train1, y_train[L1], 3)
...
# Applying PCA
x_pca_train2, x_pca_valid2, x_pca_test2 = PCAFunction(L2, x_train[L2], x_valid[L2], x_test[L2], 0.95)
...
y_pred_val_label2 = tuned_model2.predict(x_pca_valid2)
...
# Create and open a CSV file for writing
with open('layer_10_label_2.csv', mode='w', newline='') as file:
    writer = csv.writer(file)
...
#cross validation
crossValidationFunction(tuned_model2, x_pca_train2, y_train[L2], 4)
...
y_pred = tuned_model2_2.predict(x_valid_label2)
print(y_pred.shape)
print(y_valid[L2].shape)
...
y_pred = tuned_model3.predict(x_pca_valid3)
print(y_pred.shape)
...
y_pred_val_label3 = tuned_model3_2.predict(x_valid_label3)
...
# Create and open a CSV file for writing
with open('layer_10_label_3.csv', mode='w', newline='') as file:
    writer = csv.writer(file)
...
print("CSV file 'layer_10_label_3.csv' has been created.")

#cross validation
crossValidationFunction(tuned_model3_2, x_training_label3, y_train[L3], 3)
...
y_pred_val_label4 = svm.predict(x_valid[L4])
print(y_pred_val_label4.shape)
print(y_valid[L4].shape)
print('After Random Search using SVM accuracy Score :', metrics.accuracy_score(y_valid[L4], y_pred_val_label4))
...
# Create and open a CSV file for writing
with open('layer_10_label_4.csv', mode='w', newline='') as file:
    writer = csv.writer(file)
...
print("CSV file 'layer_10_label_4.csv' has been created.")
...
y_pred_label1 = tuned_model1.predict(x_pca_test1)

y_pred_label2 = tuned_model2.predict(x_pca_test2)

y_pred_label3 = tuned_model3_2.predict(x_test_label3)
...
# Create and open a CSV file for writing
with open('solutions.csv', mode='w', newline='') as file:
    writer = csv.writer(file)
...
print("CSV file 'solutions.csv' has been created.")